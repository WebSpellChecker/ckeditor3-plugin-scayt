					...
					elements : [
						{
							...
							html : 	'<form name="optionsbar_' + editorName + '"><div class="inner_options">' +
									...
									'		<label style="margin-left:5px" for="allCaps_' + editorName + '" id="label_allCaps_' + editorName + '"></label>' +
									'	</div>' +
									'	<div style="display:none;">' +
									'		<input name="options" type="checkbox"  id="ignoreDomainNames_' + editorName + '" />' +
									'		<label style="margin-left:5px" for="ignoreDomainNames_' + editorName + '" id="label_ignoreDomainNames_' + editorName + '"></label>' +
									'	</div>' +
									'	<div style="display:none;">' +
									'	<input name="options" type="checkbox"  id="mixedCase_' + editorName + '" />' +
									'		<label style="margin-left:5px" for="mixedCase_' + editorName + '" id="label_mixedCase_' + editorName + '"></label>' +
									'	</div>' +
									'	<div style="display:none;">' +
									'		<input name="options" type="checkbox"  id="mixedWithDigits_' + editorName + '" />' +
									'		<label style="margin-left:5px" for="mixedWithDigits_' + editorName + '" id="label_mixedWithDigits_' + editorName + '"></label>' +
									'	</div>' +
									'</div></form>'
						}
					]
					...
					elements : [
						{
							...
							html : 	'<form name="dictionarybar_' + editorName + '"><div class="inner_dictionary" style="text-align:left; white-space:normal; width:320px; overflow: hidden;">' +
									...
									'       <span class="cke_dialog_ui_labeled_label" ><label for = "dic_name_' + editorName + '">'+lang.dic_field_name+'</label></span><br>'+
									...
									'		</div></span></div>'+
									'		<div style="margin:5px auto; width:80%;white-space:normal;">'+
									'			<a style="display:none;" class="cke_dialog_ui_button" href="javascript:void(0)" accesskey = "Z" title = "Create dictionary" id="dic_create_' + editorName + '">'+
									'				</a>' +
									'			<a  style="display:none;" class="cke_dialog_ui_button" href="javascript:void(0)" accesskey = "X" title = "Remove dictionary" id="dic_delete_' + editorName + '">'+
									'				</a>' +
									'			<a  style="display:none;" class="cke_dialog_ui_button" href="javascript:void(0)" accesskey = "C" title = "Rename dictionary" id="dic_rename_' + editorName + '">'+
									'				</a>' +
									'			<a  style="display:none;" class="cke_dialog_ui_button" href="javascript:void(0)" accesskey = "V" title = "Restore dictionary" id="dic_restore_' + editorName + '">'+
									'				</a>' +
									'		</div>' +
	...
	var init_with_captions = function()
	{
		...
		function onDicButtonClick( ev )
		{
			...
			try{
				...
				var id = /dic_(\w)+?_/.exec(el.getId())[0];
